...
const npcs = [
  ...
  { id: "lightkeeper", name: "Lightkeeper", color: npcColors[8], quests: [
    { id: "lightkeeper_information_source", title: "Information Source", description: "삼림 Bridge V-Ex 탈출, 세관 Dorms V-Ex 탈출, 인터체인지 Power Station V-Ex 탈출, 타르코프 시내 Primorsky Ave Taxi V-Ex 탈출, 그라운드 제로 Police Cordon V-Ex 탈출, 타르코프 시내 Patrol-A 장갑차 1/2 마킹", requiresKappa: false, rewards: ["Advanced Electronic Materials textbook x1", "작업대 레벨 2 Virtex 프로그래밍 가능한 프로세서 제작"] },
    { id: "lightkeeper_missing_informant", title: "Missing Informant", description: "타르코프 시내 정보 제공자의 백업 은신처 찾기, 정보 제공자의 일기 입수, 정보를 등대지기에게 전달", requiresKappa: false, rewards: ["Microcontroller board x1", "메카닉 Microcontroller board 구매", "작업대 레벨 2 SG-C10 COFDM 군용 무선 신호 송신기 제작"] },
    { id: "lightkeeper_snatch", title: "Snatch", description: "등대에서 탈출, 등대 로그 기지에서 위조된 정보 입수, 리저브 수리소에서 원본 정보 입수, BMP-2 아래에 위조된 정보 숨기기, 원본 정보를 등대지기에게 가져가기", requiresKappa: false, rewards: ["VPX 플래시 저장소 모듈 x3", "래그맨 Atomic Defense CQCM up armored ballistic mask (Black) 구매", "작업대 레벨 2 UHF RFID 리더기 제작"] },
    { id: "lightkeeper_return_the_favor", title: "Return the Favor", description: "삼림 산악 지역 주변 PMC 처치 [x15], TerraGroup 블루 폴더를 삼림 USEC 캠프 내 지정 위치 2곳에 숨기기", requiresKappa: false, rewards: ["Silicon Optoelectronic Integrated Circuits textbook x1", "작업대 레벨 2 VPX 플래시 저장소 모듈 제작"] },
    { id: "lightkeeper_payback", title: "Payback", description: "Glukhar 처치 [x1], 경호원 처치 [x6], 레이더 기지에서 노란 신호탄 발사, 리저브에서 Cliff Descent 탈출", requiresKappa: false, rewards: ["Microcontroller board x1", "LEDX 피부 트랜스일루미네이터 x3", "래그맨 DevTac Ronin Respirator 구매"] },
    { id: "lightkeeper_provocation", title: "Provocation", description: "인터체인지에서 ASh-12로 Kiba Arms 상점 주변 대상 처치 [x20], Salty Dog 소시지, Moonshine, 화장지를 각 비밀 은신처에 숨기고 생존 탈출", requiresKappa: false, rewards: ["Virtex 프로그래밍 가능한 프로세서 x2", "작업대 레벨 3 FLIR RS-32 열화상 조준경 제작"] },
    { id: "lightkeeper_following_the_bread_crumbs", title: "Following the Bread Crumbs", description: "레이더 처치 [x20], Labs 무기 테스트/인간 실험실/매니저 사무실 조사 및 보안 테이프 회수", requiresKappa: false, rewards: ["Far-forward GPS Signal Amplifier Unit x1", "메카닉 Far-forward GPS Signal Amplifier Unit 구매"] },
    { id: "lightkeeper_spotter", title: "Spotter", description: "Concordia/프리모르스키의 저격 위치 확보, AI .338 소음기/REAP-IR 각 지정 장소에 숨기고 생존 탈출", requiresKappa: false, rewards: ["Microcontroller board x1", "작업대 레벨 3 Microcontroller board 제작"] },
    { id: "lightkeeper_make_an_impression", title: "Make an Impression", description: "볼트액션 라이플 기술 레벨 요구 달성, 350m+에서 스나이퍼 스캐브 [x10] 처치", requiresKappa: false, rewards: ["AESA 위상 배열 부품 x2", "작업대 레벨 3 Trijicon REAP-IR 열화상 조준경 제작"] },
    { id: "lightkeeper_trouble_in_the_big_city", title: "Trouble in the Big City", description: "Streets 화물 운송 지역 확보 [x50], 마커 설치, 장갑차 근처 노란 신호탄 발사, 생존 탈출", requiresKappa: false, rewards: ["Advanced current converter x1", "피스키퍼 SIG MCX-SPEAR 6.8x51 구매", "피스키퍼 L7AWM 25발 탄창 구매", "피스키퍼 6.8x51 SIG Hybrid 구매", "메카닉 Advanced current converter 구매"] },
    { id: "lightkeeper_simple_side_job", title: "Simple Side Job", description: "Reserve 군 병원 옥상 화물 획득, Woods 스캐브 집에 화물 숨기기", requiresKappa: false, rewards: ["달러 x4000", "SG-C10 COFDM 군용 무선 신호 송신기 x1", "UHF RFID 리더기 x1", "Virtex 프로그래밍 가능한 프로세서 x1"] },
    { id: "lightkeeper_order_from_outside", title: "Order From Outside", description: "Reserve 전기기계 창고에서 재머 확보, Woods 지정 위치에 장치 은닉", requiresKappa: false, rewards: ["달러 x4000", "SG-C10 COFDM 군용 무선 신호 송신기 x1", "UHF RFID 리더기 x1", "Virtex 프로그래밍 가능한 프로세서 x1"] },
    { id: "lightkeeper_keepers_word", title: "Keeper's Word", description: "미궁 내부 3곳에 컬티스트 나이프 은닉", requiresKappa: false, rewards: ["달러 x4200", "Virtex 프로그래밍 가능한 프로세서 x1", "S I C C 다용도 파우치 x1", "Sacred Amulet x1"] },
    { id: "lightkeeper_surprise_gift_pvp", title: "Surprise Gift [PVP ZONE]", description: "세관의 옛 챔피언 은신처로 돌아가 레프의 불리한 정보 획득 및 전달", requiresKappa: false, rewards: ["달러 x1000"] }
  ]},
  { id: "ref", name: "Ref", color: npcColors[9], quests: [
    { id: "ref_easy_money_part_2", title: "Easy Money - Part 2 [PVP ZONE]", description: "레이드에서 발견한 음료/식품 카테고리 아이템 건네기", requiresKappa: false, rewards: ["GP 코인 x52", "레프 평판 +0.03"] },
    { id: "ref_provide_viewership", title: "Provide Viewership", description: "Customs 산업 공장 내부 WI-FI 카메라 4곳 설치, 해당 위치에서 적 15 제거", requiresKappa: false, rewards: ["GP 코인 x45", "Lone Star TX-15 DML 5.56x45 기본 x1", "HK 30 STANAG 30발 폴리머 탄창 x3", "5.56x45mm M855A1 (50발) x3", "레프 평판 +0.02"] },
    { id: "ref_balancing_part_1", title: "Balancing - Part 1 [PVP ZONE]", description: "어느 장소에서든 Steyr AUG로 스캐브 [x5] 처치", requiresKappa: false, rewards: ["GP 코인 x45", "Steyr AUG A1 기본 x1", "M856 (50발) x3", "AUG 30발 탄창 x3", "Death Shadow lightweight armored mask x1", "레프 평판 +0.03"] },
    { id: "ref_balancing_part_2", title: "Balancing - Part 2 [PVP ZONE]", description: "어느 장소에서든 PACA 소프트 아머 착용하고 PMC [x2] 처치", requiresKappa: false, rewards: ["GP 코인 x45", "Death Shadow lightweight armored mask x2", "레프 평판 +0.03"] },
    { id: "ref_surprise", title: "Surprise [PVP ZONE]", description: "레이드에서 FIR Class 4 이상 방탄 플레이트 전달", requiresKappa: false, rewards: ["GP 코인 x55", "Maska-1SCh (Killa Edition) 기본 x1", "레프 평판 +0.04"] },
    { id: "ref_create_a_distraction_part_1", title: "Create a Distraction - Part 1 [PVP ZONE]", description: "Ground Zero 카페 2층에 TP-200 TNT 설치", requiresKappa: false, rewards: ["GP 코인 x28", "Desert Tech MDR 5.56x45 ONE x1", "PMAG 20 GEN M3 20발 x3", "M856 (100발) x1", "레프 평판 +0.05"] },
    { id: "ref_create_a_distraction_part_2", title: "Create a Distraction - Part 2 [PVP ZONE]", description: "Streets에서 카반 또는 콜론타이 경호원 [x2] 처치", requiresKappa: false, rewards: ["Degtyarev RPDN 기본 x1", "RPD 100발 박스 x1", "7.62x39mm FMJ (20발) x10", "Lega Medal x1", "레프 평판 +0.07"] },
    { id: "ref_to_great_heights_part_1", title: "To Great Heights! - Part 1 [PVP ZONE]", description: "아레나 CheckPoint 또는 LastHero 모드에서 경기 승리", requiresKappa: false, rewards: ["GP 코인 x75", "Lega Medal x1", "Remington M700 Vudu 1-6x24 x1", "M700 5발 탄창 x2", "7.62x51mm TCW SP (20발) x2", "레프 평판 +0.03"] },
    { id: "ref_to_great_heights_part_2", title: "To Great Heights! - Part 2 [PVP ZONE]", description: "아레나 TeamFight/BlastGang/CheckPoint 모드에서 경기 승리", requiresKappa: false, rewards: ["GP 코인 x52", "7.62x39mm PS gzh (20발) x3", "CMMG Mk47 Mutant 기본 x1", "US Palm AK30 30발 x3", "레프 평판 +0.03"] },
    { id: "ref_to_great_heights_part_3", title: "To Great Heights! - Part 3 [PVP ZONE]", description: "아레나 TeamFight/BlastGang/CheckPoint에서 3위 이상으로 승리", requiresKappa: false, rewards: ["GP 코인 x38", "LOBAEV DVL-10 Saboteur x1", "DVL-10 10발 탄창 x2", "7.62x51mm TCW SP (20발) x2", "레프 평판 +0.04"] },
    { id: "ref_to_great_heights_part_4", title: "To Great Heights! - Part 4 [PVP ZONE]", description: "EFT 잔액에서 루블 건네기, 6매치 중 3승 (4패 시 실패)", requiresKappa: false, rewards: ["GP 코인 x40", "루블 x1000002", "Armband (ARENA) x1", "HK MP7A1 기본 x1", "MP7 30발 탄창 x3", "4.6x30mm JSP SX (40발) x3", "레프 평판 +0.09"] },
    { id: "ref_to_great_heights_part_5", title: "To Great Heights! - Part 5 [PVP ZONE]", description: "아레나 TeamFight/BlastGang/CheckPoint에서 2연승 달성", requiresKappa: false, rewards: ["GP 코인 x40", "레프 APOK Tactical Wasteland Gladius 구매 잠금 해제", "레프 평판 +0.05"] },
    { id: "ref_against_the_conscience_part_1", title: "Against the Conscience - Part 1 [PVP ZONE]", description: "Customs 옛 챔피언 방 조사 및 무슨 일인지 파악 후 생존 탈출, Shoreline 밀수업자 기지 열쇠 확보", requiresKappa: false, rewards: ["루블 x50000", "CQC Osprey MK4A 플레이트 캐리어 (Assault, MTP) 기본 x1", "HK 416A5 기본 x1", "HK Steel Maritime STANAG 30발 x3", "5.56x45mm MK 318 Mod 0 (50발) x3"] },
    { id: "ref_against_the_conscience_part_2", title: "Against the Conscience - Part 2 [PVP ZONE]", description: "아레나의 모든 게임 모드에서 적 [x100] 제거", requiresKappa: false, rewards: ["GP 코인 x88", "SIG MCX-SPEAR 6.8x51 기본 x1", "Lancer L7AWM 20발 x3", "6.8x51mm SIG FMJ x41", "레프 평판 +0.06"] },
    { id: "ref_decisions_decisions", title: "Decisions, Decisions [PVP ZONE]", description: "레프의 불리한 정보 획득 및 전달", requiresKappa: false, rewards: ["GP 코인 x72", "Secure container Theta x1", "레프 평판 +0.15", "펜스 평판 -0.15"] },
    { id: "ref_postponed_reward", title: "Postponed Reward [PVP ZONE]", description: "Lega 메달을 레프에게 전달, Secure container Theta", requiresKappa: false, rewards: ["Secure container Theta x1", "레프 평판 +0.01"] }
  ]},
  { id: "btr", name: "BTR 운전병", color: "#d97706", quests: [
    { id: "btr_shipping_delay_part_2", title: "Shipping Delay - Part 2", description: "Woods 보급 기지 창고/사무실/차고 정찰, 'A Helping Hand' 완료", requiresKappa: false, rewards: ["루블 x84,000", "RSP-30 (Blue) x1", "Tetriz x1", "BTR 운전병 평판 +0.01"] },
    { id: "btr_hot_wheels", title: "Hot Wheels", description: "예비 BTR 바퀴를 찾아 MS2000 마커로 표시", requiresKappa: false, rewards: ["루블 x116,000", "Military power filter x1", "BTR 운전병 평판 +0.03"] },
    { id: "btr_hot_wheels_retry", title: "Hot Wheels - Let's Try Again", description: "Reserve에서 예비 BTR 바퀴를 찾아 MS2000 마커로 표시", requiresKappa: false, rewards: ["루블 x84,000", "NIXXOR 렌즈 x3", "BTR 운전병 평판 +0.02"] },
    { id: "btr_swift_retribution", title: "Swift Retribution", description: "Woods에서 스캐브 10명 처치", requiresKappa: false, rewards: ["루블 x85,000", "Old house room key x1", "BTR 운전병 평판 +0.03"] },
    { id: "btr_inevitable_response", title: "Inevitable Response", description: "Woods 스캐브 5; Woods→Reserve 수송 이용; Reserve 스캐브 5", requiresKappa: false, rewards: ["루블 x82,000", "BTR 운전병 평판 +0.02"] },
    { id: "btr_building_foundations", title: "Building Foundations", description: "Ragman/Prapor/Peacekeeper에게 아무 아이템 판매", requiresKappa: false, rewards: ["루블 x126,000", "Moonshine '맹렬한 도끼런' x1", "BTR 운전병 평판 +0.01"] },
    { id: "btr_natural_exchange", title: "Natural Exchange", description: "Shoreline 밀수업자 기지에 금속 연료통 2개 은닉", requiresKappa: false, rewards: ["루블 x96,000", "GPU x1", "BTR 운전병 평판 +0.03"] },
    { id: "btr_ask_for_directions", title: "Ask for Directions", description: "Lighthouse 절벽 길 1~4 구간 MS2000 마커로 표시", requiresKappa: false, rewards: ["루블 x85,000", "GreenBat 리튬 배터리 x2", "BTR 운전병 평판 +0.02"] },
    { id: "btr_battery_change_1", title: "Battery Change", description: "레이드에서 Tank battery 6-STEN-140-M 전달", requiresKappa: false, rewards: ["루블 x284,000", "Body armor repair kit x1", "BTR 운전병 평판 +0.03"] },
    { id: "btr_battery_change_2", title: "Battery Change", description: "레이드에서 Tank battery 6-STEN-140-M 전달", requiresKappa: false, rewards: ["루블 x284,000", "Body armor repair kit x1", "BTR 운전병 평판 +0.03"] },
    { id: "btr_protect_the_sky", title: "Protect the Sky", description: "Woods 지정 위치 패키지 수색 후 전달", requiresKappa: false, rewards: ["루블 x96,000", ".300 Blackout CBJ (50) x4", "메카닉 Velociraptor .300 BLK 기본 구매 잠금 해제", "BTR 운전병 평판 +0.02"] },
    { id: "btr_discombobulate", title: "Discombobulate", description: "Woods RPG 탄약 상자 3곳에 VOG-25 Khattabka 은닉", requiresKappa: false, rewards: ["루블 x175,000", "Military 군용 플래시 드라이브 x3", "BTR 운전병 평판 +0.03"] },
    { id: "btr_price_of_independence_1", title: "The Price of Independence", description: "Customs 편지 확보→Reserve 은닉→수송 경로로 Woods/Lighthouse 이동, 신호탄 2곳, 스캐브 10, Lighthouse 생존 탈출", requiresKappa: false, rewards: ["루블 x300,000", "메카닉 RSP-30(Blue) 구매 잠금 해제", "메카닉 GPU 구매 잠금 해제", "BTR 운전병 평판 +0.5"] },
    { id: "btr_price_of_independence_2", title: "The Price of Independence", description: "동일 목표(일부 조건 문구 차이)", requiresKappa: false, rewards: ["루블 x300,000", "메카닉 RSP-30(Blue) 구매 잠금 해제", "메카닉 GPU 구매 잠금 해제", "BTR 운전병 평판 +0.5"] },
    { id: "btr_sensory_analysis_part_2", title: "Sensory Analysis - Part 2", description: "Moonshine '맹렬한 도끼런' 전달", requiresKappa: false, rewards: ["루블 x32,000", "BTR 운전병 평판 +0.01"] }
  ]}
];
